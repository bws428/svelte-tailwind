	...
	<header class="absolute inset-x-0 top-0 z-50">
		<nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
			...
			<div class="hidden lg:flex lg:gap-x-12">
				<a href="/auth/login" class="text-sm font-semibold leading-6 text-gray-900">Product</a>
				<a href="/auth/login" class="text-sm font-semibold leading-6 text-gray-900">Features</a>
				<a href="#pricing" class="text-sm font-semibold leading-6 text-gray-900">Pricing</a>
				<a href="/auth/login" class="text-sm font-semibold leading-6 text-gray-900">About Us</a>
			</div>
		...
		<div class="lg:hidden" role="dialog" aria-modal="true">
			...
			>
				<div class="flex items-center justify-between">
					<a href="/auth/login" class="-m-1.5 p-1.5">
						<span class="sr-only">Your Company</span>
						<img
							class="h-8 w-auto"
							src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600"
		...
		<div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-40">
			...
			<div class="text-center">
				<h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
					Streamline your aviation record keeping
				</h1>
				...
				<div class="mt-10 flex items-center justify-center gap-x-6">
					<a
						...
						>Get started for free <span aria-hidden="true">→</span></a
					>
					<a href="/auth/login" class="text-sm font-semibold leading-6 text-gray-900"
						>Learn more
					</a>
			...
			<div class="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
				...
				<div class="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
					<a
						...
						>Get started</a
					>
					<a href="/auth/login" class="text-sm font-semibold leading-6 text-white"
...
<div class="bg-white py-24 sm:py-32">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="mx-auto max-w-2xl sm:text-center">
			<h2 id="pricing" class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
